...
@Database(entities = [Content::class, Status::class, StatusType::class, Category::class, ContentGenre::class, Genre::class, Rating::class, FranchiseInfo::class], version = 40, exportSchema = false)
